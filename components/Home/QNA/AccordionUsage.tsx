  ...
  return (
    <div style={{ fontFamily: "'Roboto', sans-serif" }}>
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
            말꼬리 털은 오랜시간 세척과정과 살균과정을 거쳐서 높은 탄성으로
            가공되기 때문에 안심하고 사용하실 수 있습니다. <br /> 또한 말총은
            머리카락과 달리 털이 두껍고 탄성이 뛰어나기 때문에 머리를 지지하고
            편안한 수면을 유도합니다. <br />
            <br />
            ▪ 말은 멸종 위기에 처한 종이 아닙니다. <br /> ▪ 말은 털 때문에
            죽임을 당하지 않고, <br />▪ 말은 CITES나 USFWS의 통제를 받지 않기
            때문에 안심하고 사용하실 수 있습니다.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </div>
